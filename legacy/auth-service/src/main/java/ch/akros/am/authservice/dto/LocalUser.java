...
import ch.akros.am.authservice.util.GeneralUtils;
...
public class LocalUser extends User implements OAuth2User, OidcUser {
    ...
    public LocalUser(final String userID, final String password, final boolean enabled, final boolean accountNonExpired, final boolean credentialsNonExpired,
                     final boolean accountNonLocked, final Collection<? extends GrantedAuthority> authorities, final Userdata user) {
        this(userID, password, enabled, accountNonExpired, credentialsNonExpired, accountNonLocked, authorities, user, null, null);
    }

    public LocalUser(final String userID, final String password, final boolean enabled, final boolean accountNonExpired, final boolean credentialsNonExpired,
                     final boolean accountNonLocked, final Collection<? extends GrantedAuthority> authorities, final Userdata user, OidcIdToken idToken,
    ...
    public static LocalUser create(Userdata user, Map<String, Object> attributes, OidcIdToken idToken, OidcUserInfo userInfo) {
