...
import stylesCss from 'themes/akrosmarketplaceadministration/styles.css';
import '@vaadin/vaadin-lumo-styles/typography.js';
import '@vaadin/vaadin-lumo-styles/color.js';
import '@vaadin/vaadin-lumo-styles/spacing.js';
import '@vaadin/vaadin-lumo-styles/badge.js';
import vaadinButtonCss from 'themes/akrosmarketplaceadministration/components/vaadin-button.css';
import vaadinPasswordFieldCss from 'themes/akrosmarketplaceadministration/components/vaadin-password-field.css';
import vaadinTextAreaCss from 'themes/akrosmarketplaceadministration/components/vaadin-text-area.css';
import vaadinTextFieldCss from 'themes/akrosmarketplaceadministration/components/vaadin-text-field.css';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_akrosmarketplaceadministration_componentCss']) {
    registerStyles(
      'vaadin-button',
    ...
    document['_vaadintheme_akrosmarketplaceadministration_componentCss'] = true;
  }
