Notizen von HErmann Kamdoum:

starten des localen express server : npm run server
starten des angular nodejs app mit facebook OAuth2 Unterstützung: ng serve --ssl true
starten des angular nodejs app mit azure Akros OAuth2 Unterstützung: ng serve 
